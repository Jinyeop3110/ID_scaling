...
def main(session_name, model_name, model_checkpoint, dataset_name, dataset_subset, tokens_min_length):
    ...
    print(f"Filtered dataset size: {len(chunked_dataset)}")
    ...
    pos_list = None #np.array([0, 128, 256, 384, 512, 640, 768, 896, 1024, 1152, 1280, 1408, 1536, 1664, 1792, 1920, -2,-3,-4,-5, -8, -16, -32, -64])
    cache = {}
...
if __name__ == "__main__":
    ...
    #main("test", model_name="olmo-1b", model_checkpoint="main", dataset_name='pile_uncopyrighted_parquet', dataset_subset=[0], tokens_min_length=2408*10)